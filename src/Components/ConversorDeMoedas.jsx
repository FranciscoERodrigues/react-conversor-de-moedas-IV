...
function ConversorDeMoedas() {
  ...
  useEffect(() => {
    fetch('http://api.exchangeratesapi.io/v1/latest?access_key=21276068882592a6d974b8528d730c14&format=1')
  ...
  const converterMoeda = () => {
    fetch(`http://api.exchangeratesapi.io/v1/latest?access_key=21276068882592a6d974b8528d730c14&format=1base=${deMoeda}&symbols=${paraMoeda}`)
      .then(response => response.json())
      .then(data => {
